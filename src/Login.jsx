...
function Login(){
    ...
    return(
       <>
        ...
        <TextField label="Instagram ID" style={{maxWidth: 500, minWidth:200, width:'80%',borderRadius:'5px', background:'white'}} onChange={e=>setUsername(e.target.value)} variant='filled'/>
